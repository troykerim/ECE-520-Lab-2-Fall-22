...
#
# Generated by Vivado on Sat Sep 10 15:16:02 PDT 2022
...
#
#    "/home/troy/fa22-e520-lab2-troykerim/hardware/Lab2/Lab2.srcs/sources_1/bd/subsystem_1/subsystem_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/Lab2/Lab2.srcs/sources_1/bd/subsystem_1/subsystem_1.bd"]"\
  ]
  foreach ifile $files {
...
if { [get_property IS_LOCKED [ get_files -norecurse subsystem_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/Lab2/Lab2.gen/sources_1/bd/subsystem_1/hdl/subsystem_1_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse subsystem_1.bd] -top]
...
set file "subsystem_1/subsystem_1.bd"
...
set obj [get_filesets sources_1]
set_property -name "top" -value "subsystem_1_wrapper" -objects $obj
